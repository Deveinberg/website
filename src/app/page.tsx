      ...
      <section id="home" className="min-h-screen flex items-center justify-center relative pt-[20vh]">
        ...
        >
          ...
          >
            ...
            <span className="gradient-text"> NTUSE Graduate Scholar</span> from Nanyang Technological University, exploring quantum mysteries 
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-lg text-gray-300 space-y-6 text-center md:text-left md:order-1">
                ...
                <p>
                  I&apos;ve finished working my way through a <strong>Physics degree</strong> at <strong>Nanyang Technological University</strong> as a <strong>Scholar</strong>, with a particular 
            ...
            <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              {[
                ...
                { label: "Status", value: "Graduate", desc: "Physics" },
                { label: "Projects", value: "4+", desc: "Research" },
